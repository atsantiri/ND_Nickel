{
   TGraph *ld1 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %lg %*lg %*lg %*lg %*lg %*lg");	
   TGraph *ld2 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %*lg %lg %*lg %*lg %*lg %*lg");	
   TGraph *ld3 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %*lg %*lg %lg %*lg %*lg %*lg");	
   TGraph *ld4 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %*lg %*lg %*lg %lg %*lg %*lg");	
   TGraph *ld5 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %*lg %*lg %*lg %*lg %lg %*lg");	
   TGraph *ld6 = new TGraph("../../talys/ld_allparity_all_cu65","%lg %*lg %*lg %*lg %*lg %*lg %lg");	
   ...
   TH2F *h = new TH2F("h"," ",10,-0.764000,10.436000,50,0.149632,351300.000000);
   ifstream rholev("un80keV/rholev.cnt"), rhopaw("un80keV/rhopaw.cnt"), fermi("un80keV/fermigas.cnt");
   float levels[83],rho[83],rhoerr[83],energy[627],energyerr[627],fermigas[627];
   float Bn[1]={9.911000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={25000.000000};
   float rho_Bnerr[1]={2500.000000};
   int i = 0;
   float a0 =  -0.7640;
   float a1 =   0.1600;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    8.349,1.756e+05,"^{65}Cu");
   TArrow *arrow1 = new TArrow(0.676000,58.622653,0.676000,16.349243,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(2.436000,176.091487,2.436000,49.110069,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(7.076000,20551.252422,7.076000,5731.528809,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(9.156000,75539.721787,9.156000,21067.236328,0.02,">");
   arrow4->Draw();
   c1->Update();
   c1->Print("counting_Ni64.png");

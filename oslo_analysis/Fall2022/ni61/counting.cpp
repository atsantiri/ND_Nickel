{
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    7.565,6.000e+04,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.016000,242.773936,0.016000,75.384827,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(2.416000,510.726009,2.416000,158.587830,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(6.096000,10647.402572,6.096000,3306.172852,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(7.696000,44641.450005,7.696000,13861.817383,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.824000,12.256000,50,0.060828,900000.000000);
   ifstream rholev("rholev.cnt"), rhopaw("rhopaw.cnt"), fermi("fermigas.cnt");
   float levels[93],rho[93],rhoerr[93],energy[835],energyerr[835],fermigas[835];
   float Bn[1]={11.711000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={90000.000000};
   float rho_Bnerr[1]={9000.000000};
   int i = 0;
   float a0 =  -0.8240;
   float a1 =   0.1200;
   float x,y,z;
   ...
   fermicalc->DrawGraph(61,&fermicalc->GetX()[49],&fermicalc->GetY()[49],"L");
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    9.805,4.500e+05,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(1.096000,37.892647,1.096000,9.619017,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(1.936000,234.267038,1.936000,59.468491,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(5.056000,1780.002998,5.056000,451.852264,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(7.576000,26181.386877,7.576000,6646.123047,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    9.805,1.250e+05,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.736000,26.796255,0.736000,7.731791,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(2.896000,246.119601,2.896000,71.015343,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(4.096000,493.661961,4.096000,142.441208,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(6.976000,8087.953944,6.976000,2333.697998,0.02,">");
   arrow4->Draw();
   c1->Update();

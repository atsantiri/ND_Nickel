{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.704000,12.256000,50,0.239462,500000.000000);
   ...
   float Bnerr[1]={0.001};
   float rho_Bn[1]={50000.000000};
   float rho_Bnerr[1]={5000.000000};
   int i = 0;
   float a0 =  -0.7040;
   float a1 =   0.2400;
   float x,y,z;
   ...
   fermicalc->DrawGraph(35,&fermicalc->GetX()[20],&fermicalc->GetY()[20],"L");
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    9.805,1.00e+05,"^{61}Cu");
   TArrow *arrow1 = new TArrow(0.976000,44.087052,0.976000,11.868999,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(2.896000,293.928695,2.896000,79.130699,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(4.096000,632.026984,4.096000,170.152618,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.296000,1976.335996,5.296000,532.063904,0.02,">");
   arrow4->Draw();
   c1->Update();

...
#else
const double g_dConESpac = 0.1; // MeV; wont matter if forcing bin number
int g_nConEBin;
#endif // bForceBinNum
...
const double g_adExI[] = {7.14}; // MeV
const double g_adSpI[]  = {0.5};//,0.5,1.5}; // hbar
const double g_anParI[] = {1};//,0,0}; // Pi 1 for +, 0 for -

...
const double g_adExI[] = {7.11,7.12,7.13,7.14}; // MeV
const double g_adSpI[]  = {0.5,0.5,0.5,0.5};//,0.5,1.5}; // hbar
const double g_anParI[] = {1,1,1,1};//,0,0}; // Pi 1 for +, 0 for -
const double g_adBRI[]   = {0.2,0.3,0.3,0.2};//0.5,0.25,0.25}; // Branching Ratio: has to sum up to 1.0
#endif

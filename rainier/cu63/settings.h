...
const TString slevels_file = "mylevels_z029_fixed.dat"; // might e.g. add missing half-life
...
const double g_adSigE1[] = {190., 0.00};  // mb magnitude
const double g_adEneE1[] = {16.80, 0.01}; // MeV centroid energy, non-zero
const double g_adGamE1[] = {4.96, 0.00};  // MeV GDR width
//                                  ^^^^ for a 2nd resonance
...
const double g_adExI[] = {10.};//{10.,10.,10.,10.,10.,10.,10.}; // MeV
const double g_adSpI[] = {3.5};
const double g_anParI[] = {0};
const double g_adBRI[] = {1.};//{0.072,0.114,0.179,0.161,0.084,0.266,0.124};   // Branching Ratio: has to sum up to 1.0
#endif
